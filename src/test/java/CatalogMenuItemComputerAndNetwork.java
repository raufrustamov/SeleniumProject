...
public class CatalogMenuItemComputerAndNetwork {
    ...
    public void CheckForExistingItemsInComputerAndNetworkSectionTest() {
        ...
        assertEquals(CatalogMenuItems.computerAndNetworkMenuItemsTemplate(), catalogPage.getMenuItemsInCatalogElements());
    }
